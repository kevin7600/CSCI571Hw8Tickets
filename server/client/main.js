    ...
    function SearchComponent(servicesService) {
        ...
        this.servicesService.getRequestToServer().subscribe(function (temp) {
            ...
            for (var i = 0; i < arr.length; i++) {
                _this.autComOps.push(arr[i]['name']);
            }
        });
    }
